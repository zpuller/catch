...
export default class StaticEntities {
    constructor(handlers) {
        this.bodies = createBodies([
            ...
            // Bench
            { s: { 'w': 1.36, 'h': 0.035, 'd': 0.355 }, p: { 'x': 2.75, 'y': 0.43, 'z': -0.85 }, q: { 'x': 0.0, 'y': 0.0, 'z': -0.0, 'w': 1.0 } },
            { s: { 'w': 0.04, 'h': 0.2, 'd': 0.31 }, p: { 'x': 1.73, 'y': 0.2, 'z': -0.89 }, q: { 'x': 0.0, 'y': 0.0, 'z': -0.0, 'w': 1.0 } },
            { s: { 'w': 0.04, 'h': 0.2, 'd': 0.31 }, p: { 'x': 3.86, 'y': 0.2, 'z': -0.89 }, q: { 'x': 0.0, 'y': 0.0, 'z': -0.0, 'w': 1.0 } },
            // TV Stand
